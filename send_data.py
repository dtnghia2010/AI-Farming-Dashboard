...
def get_sensor_data():
    ...
    lux = random.randint(0, 1000)  # Random light level between 0 and 1000 lux
    dust = random.uniform(0, 500)  # Random dust density between 0 and 500 µg/m³
    temp = random.uniform(20, 30)  # Random temperature between 20°C and 30°C
    wtlv = random.randint(0, 100)  # Random water level between 0 and 100%
    return {
        'co': co,
        'co2': co2,
        'lux': lux,
